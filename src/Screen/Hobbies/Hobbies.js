...
//     setLoading(true);
//     try {
//       const response = await hobbiesapi.getAllhobbies(currentPage, perPage);
...
//   useEffect(() => {
//     getHobbies();
//   }, [currentPage, perPage]); // Include currentPage and perPage as dependencies

//   const handleDelete = async (id) => {
//     try {
//       await hobbiesapi.deleteHobbies(id);
//       getHobbies();
//     } catch (error) {
...
//     try {
//       await hobbiesapi.updateHobbies(updatedHobby.id, updatedHobby);
//       closeUpdateModal();
//       getHobbies();
//     } catch (error) {
...
//                     <td>
//                       <button onClick={() => openUpdateModal(hobby)}>
//                         Edit
//                       </button>
//                       <button onClick={() => handleDelete(hobby.id)}>
//                         Delete
//                       </button>
//                     </td>
//                   </tr>
